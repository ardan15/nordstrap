...
if ( ! function_exists( 'wordstrap_setup' ) ) :
	...
	function wordstrap_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'wordstrap' ),
		) );
 ...
 */
function wordstrap_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'wordstrap_content_width', 640 );
}
add_action( 'after_setup_theme', 'wordstrap_content_width', 0 );
...
function wordstrap_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'wordstrap' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'wordstrap' ),
...
function wordstrap_scripts() {
	wp_enqueue_style( 'wordstrap-style', get_stylesheet_uri() );

	wp_enqueue_script( 'wordstrap-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'wordstrap-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
